...
namespace ExEngine::Render
{
	...
	Vertex Quad::_vert[4] = {
		{ DirectX::XMFLOAT3(-1.0f, 1.0f, 0.001f), DirectX::XMFLOAT2(0.0f, 0.0f) },  // 左上
		{ DirectX::XMFLOAT3(1.0f, 1.0f, 0.001f), DirectX::XMFLOAT2(1.0f, 0.0f) },	// 右上
		{ DirectX::XMFLOAT3(-1.0f, -1.0f, 0.001f), DirectX::XMFLOAT2(0.0f, 1.0f) }, // 左下
		{ DirectX::XMFLOAT3(1.0f, -1.0f, 0.001f), DirectX::XMFLOAT2(1.0f, 1.0f) }, // 右下
	};
